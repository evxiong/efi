    ...
    <div className="flex w-full flex-col">
      ...
      <section className="flex w-full flex-col gap-3 border-b bg-white">
        <div className="mx-auto flex max-w-7xl flex-col justify-center gap-4 px-4 md:flex-row md:items-center md:px-6">
          <div className="flex flex-row items-center gap-6 text-xs font-medium leading-3 text-gray-500">
      ...
      <section className="flex w-full flex-col gap-3 border-b bg-gray-50">
        <div className="mx-auto flex h-full w-full max-w-7xl flex-col justify-center px-0 md:px-6">
          <div className="flex h-full flex-row gap-1 py-1">
            ...
            <div className="text-xxs flex w-16 flex-shrink-0 flex-col items-center justify-center">
              <div className="rounded-sm border border-gray-200 px-1.5 py-1">
                Feb. 12
              </div>
            </div>
            <Scoreboard />
      ...
      <section className="flex w-full flex-col gap-3 border-b bg-gradient-to-br from-purple-100 to-white py-6 md:py-12">
        <div className="mx-auto flex w-full max-w-7xl flex-col justify-center px-4 md:px-6">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              <div className="mb-1 text-3xl font-light">Premier League</div>
              <div className="text-gray-700">ENGLAND</div>
            </div>
...
function Scoreboard() {
  return (
    <div className="flex h-full min-w-32 flex-col gap-1.5 bg-white px-1.5 py-1 text-[13px]">
      <div className="text-xxs flex flex-row justify-between gap-1 text-gray-700">
        <div>12:00pm</div>
        <div>Peacock</div>
      </div>
      <div className="flex flex-col gap-1">
        <div className="flex flex-row justify-between gap-1 font-medium text-gray-900">
          <div className="flex flex-row items-center gap-1.5">
            ...
            <span className="leading-4">NFO</span>
          </div>
